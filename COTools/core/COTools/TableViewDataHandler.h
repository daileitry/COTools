...
typedef void(^TableViewDataHandlerBeginDraggingBlock)();//开始拖动的block
...
@property (nonatomic, copy) TableViewDataHandlerBeginDraggingBlock tableViewDataHandlerBeginDraggingBlock;
